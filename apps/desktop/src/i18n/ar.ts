...
export const ar = defineLocale({
  ...
  composer: {
    ...
    snippetsAdd: 'إضافة مقتطف',
    snippetsEdit: 'تحرير',
    snippetsAddTitle: 'مقتطف جديد',
    snippetsEditTitle: 'تحرير المقتطف',
    snippetsEditDesc: 'احفظ لتحديث القائمة. انقر صفًا لإدراجه في المحرّر.',
    snippetsName: 'الاسم',
    snippetsHint: 'الوصف',
    snippetsTemplate: 'Template',
    snippetsDeleteTitle: 'حذف هذا المقتطف؟',
    snippetsDeleteDesc: label => `سيتم إزالة «${label}» من القائمة.`,
