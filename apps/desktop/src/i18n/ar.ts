...
export const ar = defineLocale({
  ...
  composer: {
    ...
    templateAddFolder: 'إضافة مجلد',
    templateEdit: 'تحرير',
    templateDelete: 'حذف',
    templateReorder: 'اسحب لإعادة الترتيب',
    templateMoveUp: 'تحريك لأعلى',
    templateMoveDown: 'تحريك لأسفل',
    templateIndent: 'تداخل تحت المجلد أعلاه',
    templateOutdent: 'إخراج من المجلد',
    templateReset: 'استعادة الافتراضي',
    templateFolderPlaceholder: 'اسم المجلد',
    templateConfirmDeleteFolder: 'حذف هذا المجلد وكل ما بداخله؟',
