...
export const en: Translations = {
  ...
  composer: {
    ...
    snippetsEdit: 'Edit',
    snippetsAddTitle: 'New snippet',
    snippetsEditTitle: 'Edit snippet',
    snippetsEditDesc: 'Save to update the list. Click a row to insert it into the composer.',
    snippetsName: 'Name',
    snippetsHint: 'Description',
    snippetsTemplate: 'Template',
    snippetsDeleteTitle: 'Delete this snippet?',
    snippetsDeleteDesc: label => `“${label}” will be removed from the list.`,
