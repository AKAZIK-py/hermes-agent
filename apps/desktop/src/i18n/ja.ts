...
export const ja = defineLocale({
  ...
  composer: {
    ...
    snippetsEdit: '編集',
    snippetsAddTitle: '新しいスニペット',
    snippetsEditTitle: 'スニペットを編集',
    snippetsEditDesc: '保存すると一覧に反映されます。行をクリックするとコンポーザーに挿入します。',
    snippetsName: '名前',
    snippetsHint: '説明',
    snippetsTemplate: 'Template',
    snippetsDeleteTitle: 'このスニペットを削除しますか？',
    snippetsDeleteDesc: label => `「${label}」が一覧から削除されます。`,
