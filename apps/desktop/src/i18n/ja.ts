...
export const ja = defineLocale({
  ...
  composer: {
    ...
    snippets: {
      socraticQuestioning: {
        label: 'ソクラテス式質問',
        description: '問い詰めで問題を明確にし、本当に答える価値のある問いを見つけます。',
      ...
      dualLayerExplanation: {
        label: '二層解説法',
        description: '初心者版と専門家版の二層で説明し、比喩ではなく仕組みを理解します。',
      ...
      reverseDeconstruction: {
        label: '逆分解',
        description: '優れた成果物がなぜ有効かを分解し、再利用可能なパターンを抽出します。',
      ...
      crossLongitudinalAnalysis: {
        label: '縦横分析法',
        description: '縦軸で歴史、横軸で競合比較。見知らぬ領域を素早く理解します。',
      ...
      factCheck: {
        label: '事実確認',
        description: '主張を事実・結論・価値判断に分解し、出典を確認して信頼度を判定します。',
      ...
      expertConsultation: {
        label: '専門家会議',
        description: '補完的な専門家を集めて相互に質疑させ、対立点から真の情報を得ます。',
      ...
      firstPrinciples: {
        label: '第一原理',
        description: '基本事実と制約にまで分解し、経路依存を脱して道を再導出します。',
      ...
      crossDomainTransfer: {
        label: '分野横断の転用',
        description: '問題を抽象化し、遠い分野から解決策を借りてきます。',
      ...
      dualSteelman: {
        label: '双方向スティールマン',
        description: '各選択肢の最強版を構築して相互に質疑し、決断を支援します。',
      ...
      minimalExperiment: {
        label: '最小実験',
        description: '検証すべき仮説を見つけ、低コストで可逆な実験を設計して第一歩を踏み出します。',
      ...
      hiddenTalent: {
        label: '隠れた才能の発掘',
        description: '癖・嫉妬・エネルギーパターンを深掘りし、個人の才能ハンドブックを生成します。',
      ...
      lifeDesign: {
        label: 'ライフデザイン術',
        description: 'スタンフォード式ライフデザインで、現在地を確認し方向を見つけ未来を試します。',
