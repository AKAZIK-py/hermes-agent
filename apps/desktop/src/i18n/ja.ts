...
export const ja = defineLocale({
  ...
  composer: {
    ...
    templateAddFolder: 'フォルダーを追加',
    templateEdit: '編集',
    templateDelete: '削除',
    templateReorder: 'ドラッグして並べ替え',
    templateMoveUp: '上に移動',
    templateMoveDown: '下に移動',
    templateIndent: '上のフォルダーに入れる',
    templateOutdent: 'フォルダーから出す',
    templateReset: 'デフォルトに戻す',
    templateFolderPlaceholder: 'フォルダー名',
    templateConfirmDeleteFolder: 'このフォルダーとその中身をすべて削除しますか？',
