...
export const zhHant = defineLocale({
  ...
  composer: {
    ...
    snippets: {
      socraticQuestioning: {
        label: '蘇格拉底式提問',
        description: '透過追問幫你把問題想清楚，找到真正值得回答的問題。',
      ...
      dualLayerExplanation: {
        label: '雙層解釋法',
        description: '分小白版與專業版兩層解釋，真正理解機制而非停留在類比。',
      ...
      reverseDeconstruction: {
        label: '反向拆解',
        description: '拆解優秀成品為什麼有效，提煉可複用規律與操作清單。',
      ...
      crossLongitudinalAnalysis: {
        label: '縱橫分析法',
        description: '縱軸看歷史演化、橫軸比競品差異，半小時搞懂任何陌生領域。',
      ...
      factCheck: {
        label: '事實核查',
        description: '拆分事實/結論/價值判斷，聯網核查來源，標記可信度。',
      ...
      expertConsultation: {
        label: '專家會診',
        description: '組建互補的專家團互相質疑，真正的資訊都在分歧裡。',
      ...
      firstPrinciples: {
        label: '第一性原理',
        description: '拆回最底層事實與約束，擺脫路徑依賴，重新推導方案。',
      ...
      crossDomainTransfer: {
        label: '跨領域借解',
        description: '把問題抽象成底層結構，從其他領域尋找已解決的方案。',
      ...
      dualSteelman: {
        label: '雙向鋼人論證',
        description: '為每個選項構建最強版本再互相質詢，幫你做艱難決策。',
      ...
      minimalExperiment: {
        label: '最小實驗替代空想',
        description: '找出最需驗證的假設，設計低成本可逆實驗，邁出第一步。',
      ...
      hiddenTalent: {
        label: '挖掘隱藏天賦',
        description: '深度追問你的怪癖、嫉妒與能量模式，生成個人天賦說明書。',
      ...
      lifeDesign: {
        label: '人生設計術',
        description: '基於史丹佛人生設計方法，看清位置、找到方向、試出未來。',
