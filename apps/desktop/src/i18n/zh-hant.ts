...
export const zhHant = defineLocale({
  ...
  composer: {
    ...
    templateAdd: '新增模板',
    templateAddFolder: '新增資料夾',
    templateEdit: '編輯',
    templateDelete: '刪除',
    templateReorder: '拖曳以排序',
    templateMoveUp: '上移',
    templateMoveDown: '下移',
    templateIndent: '移入上方資料夾',
    templateOutdent: '移出資料夾',
    templateReset: '還原預設',
    templateFolderPlaceholder: '資料夾名稱',
    templateConfirmDeleteFolder: '刪除此資料夾及其內所有內容？',
